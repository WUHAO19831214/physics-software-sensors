"""Language-level interface skeleton; JSON Schema remains authoritative."""
...
SensorEvent = Mapping[str, Any]
FramePacket = Mapping[str, Any]
...
class ProcessorSensor(SensorLifecycle, Protocol):
    def process(self, input_packet: FramePacket | SensorEvent) -> AsyncIterator[SensorEvent]: ...
