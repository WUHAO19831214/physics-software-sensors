...
记录：[Phase 2 adapter verification](../../../benchmarks/results/phase2-adapter-verification-2026-08-16.md) · [dataset card](../../../benchmarks/datasets/color-marker-synthetic-golden/dataset-card.md)
