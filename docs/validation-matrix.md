...
| `tracker.spot-centroid` | weighted centroid | source match 6/6, max `0 px` | OpenCV/NumPy synthetic | optical spot not tested | six synthetic frames | median/p95 measured | wheel tested | not measured | E2 |
