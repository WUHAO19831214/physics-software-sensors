...
All seven direct-observation cases agreed within `1e-9 px`; the maximum floating-point delta was `7.105427357601002e-15`. Both paths derived `28 px` and `0.56 cm` for the project-owned three-frame sequence. Clean installation, all three modes, three downstream tests, static app startup, JavaScript syntax and rollback to legacy passed both before merge and on downstream `main` after merge.
